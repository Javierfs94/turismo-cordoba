<section>
	...
	<div class="row" style="text-align:center;">
		<div class="col-sm-12 message m-4">
			<h1>Parece que andas perdido</h1>

			<a href="<?php echo base_url(); ?>home" class="button btn-effect m-2">

				<span>En estos casos es mejor volver al principio</span>
		...
		<div class="col-sm-12  justify-content-center">
			<svg style="width: 250px; height: 250px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 288 288">
