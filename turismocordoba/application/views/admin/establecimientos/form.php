                    ...
                    <div class="card">
                        <div class="card-body register-card-body">
                            ...
                            <div class="form-group row">
                                ...
                                echo '<label for="nombre_establecimiento" class="col-sm-2 col-form-label">Nombre establecimiento</label>';
                            ...
                            <div class="form-group row">
                                ...
                                echo '<label for="nombre_establecimiento" class="col-sm-2 col-form-label">Dirección</label>';
